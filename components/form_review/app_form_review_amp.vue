<template>
	<amp-script layout="container" :src="ReviewFormPathScript" class="sample">
			...
			<div class="container">
				...
				<div class="reviews_form_wrapper">
					<div class="reviews_form_wrapper_input">
						<input type="text" class="form_input jsInputName" name="name" :placeholder="translates.NAME[config.LANG]" />
						<input
							type="text"
					...
					<textarea
						class="form_textarea jsInputMsg"
						name="msg"
					...
					<div class="form_review_rating">
						...
						<span class="form_rating_value"
							><b class="jsCurrentRating">{{ currentRating }}</b
							>/10</span
						>
					</div>
					<div class="form_review_submit">
						<button
							class="form_review_send"
...
import { REVIEW_FORM as ReviewFormPathScript } from '~/config/ampPathScript'
export default {
